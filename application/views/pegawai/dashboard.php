                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3><?= $pengajuan['total_pengajuan'] ?></h3>

                                    <p>Data Pengajuan</p>
                                </div>
                                
                                <a href="<?= base_url(); ?>Pengajuan/view_pegawai/<?= $this->session->userdata('id_user'); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
